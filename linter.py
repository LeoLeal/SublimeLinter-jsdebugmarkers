...
#
# Written by Leonardo Leal
# Copyright (c) 2015 The SublimeLinter Community
#
# License: MIT
#

"""This module exports the JsDebugMarkers plugin class."""
...
class JsDebugMarkers(Linter):

    """Discovers and marks console.log, console.error, alertand debugger;."""
    ...
    # We are only interested in source code for javascript
    selectors = {
        '*': 'source.js'
    }
    ...
    defaults = {
        ...
        '-warnings:,': ['console.log(', 'alert(', 'debugger;']
    }
